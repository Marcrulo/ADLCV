...
if __name__ == '__main__':
    ...
    diffusion = Diffusion(img_size=img_size, T=500, beta_start=1e-4, beta_end=0.02, device=device)
    ...
    _, val_loader, _ = prepare_dataloader(keep_label='cg', label='shortcut', batch_size=1, val_batch_size=1)
    ...
    ########################################## Qualitative Results ############################################
    _, val_loader,_ = prepare_dataloader(keep_label='cg', label='shortcut')
